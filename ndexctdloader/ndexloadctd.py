...
class NDExNdexctdloaderLoader(object):
    """
    ...
    def run(self):
        """
        Runs content loading for NDEx CTD Content Loader
        :param theargs:
        :return:
        """
        self._parse_config()
...
def main(args):
    ...
    Loads NDEx CTD Content Loader data into NDEx (http://ndexbio.org).
    ...
    """.format(confname=NDExUtilConfig.CONFIG_FILE,
               ...
               version=ndexctdloader.__version__)
    theargs = _parse_arguments(desc, args[1:])
    theargs.program = args[0]
    theargs.version = ndexctdloader.__version__

    try:
        _setup_logging(theargs)
        loader = NDExNdexctdloaderLoader(theargs)
        return loader.run()
